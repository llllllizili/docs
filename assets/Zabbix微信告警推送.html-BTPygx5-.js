import{_ as a,c as e,b as n,a as i,f as p,o as l}from"./app-BzVjef_u.js";const c="/assets/zabbix-text-ByrjBhJh.jpg",r="/assets/zabbix-2-Cx8sXLEk.png",d="/assets/zabbix-3-DBDkD4it.jpg",t="/assets/zabbix-4-yCszR6mg.jpg",v="/assets/zabbix-5--NVaGVM-.jpg",u="/assets/zabbix-6-Dw-9EUXq.jpg",o="/assets/zabbix-7-BypA0lOQ.jpg",m={};function b(g,s){return l(),e("div",null,[s[0]||(s[0]=n("div",{class:"hint-container caution"},[n("p",{class:"hint-container-title"},"请注意"),n("p",null,"本文内容可能已过时，部分接口，参数等，存在变更的可能，请自行甄别。")],-1)),s[1]||(s[1]=n("figure",null,[n("img",{src:c,alt:"文本告警",tabindex:"0",loading:"lazy"}),n("figcaption",null,"文本告警")],-1)),s[2]||(s[2]=n("p",null,[n("strong",null,"前言")],-1)),s[3]||(s[3]=n("p",null,"zabbx告警结合微信,可以更及时对故障进行响应和处理。",-1)),s[4]||(s[4]=n("p",null,"另：文末有进阶版实现效果",-1)),i("more"),s[5]||(s[5]=p('<hr><p><strong>告警的模式分为两种,第一种就是本文消息的直接推送,第二种是图文推送,可做到交互,本文主要介绍第一种</strong></p><h2 id="前提条件" tabindex="-1"><a class="header-anchor" href="#前提条件"><span>前提条件</span></a></h2><blockquote><ol><li>zabbix</li><li>企业号</li><li>脚本</li></ol></blockquote><h2 id="企业号" tabindex="-1"><a class="header-anchor" href="#企业号"><span>企业号</span></a></h2><p>申请，略</p><h3 id="获取信息" tabindex="-1"><a class="header-anchor" href="#获取信息"><span>获取信息</span></a></h3><p>取得企业号的部门ID,应用ID, CorpID,Secret</p><figure><img src="'+r+`" alt="企业号信息" tabindex="0" loading="lazy"><figcaption>企业号信息</figcaption></figure><h2 id="脚本" tabindex="-1"><a class="header-anchor" href="#脚本"><span>脚本</span></a></h2><p>脚本可以推送两种格式,文本和新闻.</p><h3 id="推送文本" tabindex="-1"><a class="header-anchor" href="#推送文本"><span>推送文本</span></a></h3><p><strong>来自网上, 视情况修改4处 <code>self.__corpid</code> 和<code>self.__secret</code> <code>toparty</code> <code>agentid</code></strong></p><div class="language- line-numbers-mode" data-ext="" data-title=""><pre class="shiki shiki-themes one-dark-pro one-dark-pro vp-code" style="background-color:#282c34;--shiki-dark-bg:#282c34;color:#abb2bf;--shiki-dark:#abb2bf;" tabindex="0"><code><span class="line"><span>#!/usr/bin/env python</span></span>
