import{_ as t,X as p,Y as l,a0 as n,a1 as s,a2 as e,Z as i,$ as c,F as o}from"./framework-7663974c.js";const r={},d={class:"hint-container info"},u=n("p",{class:"hint-container-title"},"🔔",-1),m={href:"https://github.com/liquanzhou/ops_doc",target:"_blank",rel:"noopener noreferrer"},v=c(`<h1 id="" tabindex="-1"><a class="header-anchor" href="#" aria-hidden="true">#</a></h1><h2 id="文件" tabindex="-1"><a class="header-anchor" href="#文件" aria-hidden="true">#</a> 文件</h2><h3 id="基础命令" tabindex="-1"><a class="header-anchor" href="#基础命令" aria-hidden="true">#</a> 基础命令</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>    <span class="token function">ls</span> <span class="token parameter variable">-rtl</span>                 <span class="token comment"># 按时间倒叙列出所有目录和文件 ll -rt</span>
