import{_ as d,X as t,Y as c,a0 as a,a1 as e,a2 as n,a3 as o,$ as r,F as i}from"./framework-7663974c.js";const u={},p=a("h1",{id:"",tabindex:"-1"},[a("a",{class:"header-anchor",href:"#","aria-hidden":"true"},"#")],-1),v={href:"https://github.com/goharbor/harbor-helm",target:"_blank",rel:"noopener noreferrer"},h=r(`<h2 id="-1" tabindex="-1"><a class="header-anchor" href="#-1" aria-hidden="true">#</a></h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>helm repo <span class="token function">add</span> harbor https://helm.goharbor.io
helm repo update 
