import{_ as n,X as s,Y as a,$ as e}from"./framework-7663974c.js";const i={},l=e(`<h1 id="" tabindex="-1"><a class="header-anchor" href="#" aria-hidden="true">#</a></h1><h2 id="host解析设置" tabindex="-1"><a class="header-anchor" href="#host解析设置" aria-hidden="true">#</a> Host解析设置</h2><p>通过修改 <mark>CoreDNS ConfigMap</mark>, 即可实现，无限在values中添加过多的HostAlias</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>kubectl edit configmap coredns <span class="token parameter variable">-n</span> kube-system
