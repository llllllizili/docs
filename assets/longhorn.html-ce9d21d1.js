import{_ as u,X as m,Y as v,$ as n,a0 as s,a1 as a,a2 as e,a3 as l,F as i}from"./framework-abbf9d44.js";const b="/assets/2023-12-05-15-45-50-49f11855.png",h={},k=n("h1",{id:"",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#","aria-hidden":"true"},"#")],-1),g={href:"https://longhorn.io/docs/1.5.3/deploy/important-notes/",target:"_blank",rel:"noopener noreferrer"},_=l(`<p>支持多种安装方式，这里使用helm 安装</p><h2 id="前置准备" tabindex="-1"><a class="header-anchor" href="#前置准备" aria-hidden="true">#</a> 前置准备</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>yum <span class="token parameter variable">--setopt</span><span class="token operator">=</span>tsflags<span class="token operator">=</span>noscripts <span class="token function">install</span> iscsi-initiator-utils
