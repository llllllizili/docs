import{_ as n,X as s,Y as a,a3 as e}from"./framework-abbf9d44.js";const t="/assets/2023-12-26-15-44-13-aa799b8a.png",l="/assets/2023-12-28-11-01-53-dc87f6d4.png",p={},i=e('<h1 id="" tabindex="-1"><a class="header-anchor" href="#" aria-hidden="true">#</a></h1><h2 id="安装" tabindex="-1"><a class="header-anchor" href="#安装" aria-hidden="true">#</a> 安装</h2><blockquote><p>runner 的安装，在打开runner界面时，即可查看相关的手册</p></blockquote><figure><img src="'+t+`" alt="" tabindex="0" loading="lazy"><figcaption></figcaption></figure><h3 id="在k8s中安装" tabindex="-1"><a class="header-anchor" href="#在k8s中安装" aria-hidden="true">#</a> 在K8S中安装</h3><p>仓库添加</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>helm repo <span class="token function">add</span> gitlab https://charts.gitlab.io
