import{_ as p,X as i,Y as l,$ as n,a0 as s,a1 as t,a3 as a,F as o}from"./framework-abbf9d44.js";const c={},u=a('<h1 id="" tabindex="-1"><a class="header-anchor" href="#" aria-hidden="true">#</a></h1><h2 id="django简介" tabindex="-1"><a class="header-anchor" href="#django简介" aria-hidden="true">#</a> Django简介</h2><p><strong>urls.py</strong></p><blockquote><p>网址入口，关联到对应的view.py中的一个函数（或者generic类），访问网址就对应一个函数</p></blockquote><p><strong>view.py</strong></p><blockquote><p>处理用户发出的请求，从urls.py中对应过来，通过选人templates中的网页，可将内容显示，比如，登陆后的用户名，用户请求的数据，输出到网页</p></blockquote><p><strong>models.py</strong></p><blockquote><p>与数据库关联，存入或读取数据的时候会用到这个</p></blockquote><p><strong>forms.py</strong></p><blockquote><p>表单，用户在浏览器上输入数据提交，对数据的验证工作以及输入框的生成等工作</p></blockquote><p><strong>templates</strong>文件夹</p><blockquote><p>views.py 中的函数渲染templates中的Html模板，得到动态内容的网页，当然可以用缓存来提高速度。</p></blockquote><p><strong>admin.py</strong></p><blockquote><p>后台，可以用很少的代码量，拥有一个强大的后台</p></blockquote><p><strong>settings.py</strong></p><blockquote><p>Django 的设置，配置文件，比如Debug开关，静态文件位置等</p></blockquote><h2 id="django环境搭建" tabindex="-1"><a class="header-anchor" href="#django环境搭建" aria-hidden="true">#</a> Django环境搭建</h2><blockquote><p>Django 1.5.x 支持 Python 2.6.5 Python 2.7, Python 3.2 和 3.3.</p><p>Django 1.6.x 支持 Python 2.6.X, 2.7.X, 3.2.X 和 3.3.X</p><p>Django 1.7.x 支持 Python 2.7, 3.2, 3.3, 和 3.4 （注意：Python 2.6 不支持了）</p><p><strong>Django 1.8.x 支持 Python 2.7, 3.2, 3.3, 3.4 和 3.5. （长期支持版本 LTS)</strong></p><p>Django 1.9.x 支持 Python 2.7, 3.4 和 3.5. 不支持 3.3 了</p><p>Django 1.10.x 支持 Python 2.7, 3.4 和 3.5.</p><p><strong>Django 1.11.x 下一个长期支持版本，将于2017年4月发布</strong></p></blockquote>',18),d={href:"https://www.djangoproject.com/download/",target:"_blank",rel:"noopener noreferrer"},r=a(`<blockquote><p>使用最新版本的问题就是，可能要用到的一些第三方插件没有及时更新，无法正常使用这些三方包。</p></blockquote><blockquote><p>如果是学习，可以选择目前的 Django 1.8.x 来进行，遇到问题也容易找到答案。</p><p>当然如果需要新版本的功能也可以使用新版本，毕竟 Django 1.9 以后admin界面还是更漂亮些</p></blockquote><h3 id="django基础部分" tabindex="-1"><a class="header-anchor" href="#django基础部分" aria-hidden="true">#</a> Django基础部分</h3><h2 id="安装django" tabindex="-1"><a class="header-anchor" href="#安装django" aria-hidden="true">#</a> 安装Django</h2><p>安装pip</p><p>ubuntu <code>sudo apt-get install python-pip</code></p><p>centos <code>yum -y install python-pip</code></p><p>升级pip</p><p><code>pip install --upgrade pip</code></p><p>利用pip安装Django</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>（sudo<span class="token punctuation">)</span> pip <span class="token function">install</span> Django
