import{_ as s,X as a,Y as i,a0 as e,a1 as l,a2 as d,$ as r,F as t}from"./framework-7663974c.js";const o="/assets/2023-07-22-11-21-04-7dcd5067.png",c={},u=r(`<h1 id="" tabindex="-1"><a class="header-anchor" href="#" aria-hidden="true">#</a></h1><div class="hint-container warning"><p class="hint-container-title">请注意</p><p>此部分内容，记录于几年前，请注意内容的有效性。</p></div><h2 id="安装" tabindex="-1"><a class="header-anchor" href="#安装" aria-hidden="true">#</a> 安装</h2><blockquote><p>安装Nginx</p></blockquote><p><strong>nginx默认使用80端口，请确保80未被使用</strong></p><p>Nginx安装包</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">wget</span> http://www.nginx.org/download/nginx-<span class="token punctuation">[</span>version<span class="token punctuation">]</span>.tar.gz
