import{_ as e,X as i,Y as n,a3 as s}from"./framework-abbf9d44.js";const d={},a=s(`<div class="hint-container danger"><p class="hint-container-title">请注意</p><p>本文内容可能已过时，请自行甄别。</p></div><h2 id="db权限" tabindex="-1"><a class="header-anchor" href="#db权限" aria-hidden="true">#</a> DB权限</h2><ol><li>在客户端的mysql里添加权限,使用zabbix账号连接本地的mysql</li></ol><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>mysql<span class="token operator">&gt;</span> grant all on *.* to zabbix@<span class="token string">&#39;localhost&#39;</span> identified by &quot;zabbix”<span class="token punctuation">;</span>
